...
(function(){
  ...
  function sat(now){
    ...
    g.addColorStop(0,'rgba(232,228,216,0)'); g.addColorStop(1,'rgba(232,228,216,'+(0.42*f)+')');
    ...
    ctx.fillStyle='rgba(245,229,167,'+(0.24*f)+')';
